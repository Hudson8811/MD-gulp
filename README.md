## Куча косяков в сборке, надо будет фиксить
* убрать dist из gitignore
* В gulp-tasks/serve.js прописать 
        server: {
            directory: true,
            baseDir: "./dist/"
        },
* Нормальный сделать резет на базе общего старого, который я по ходу дела расширял и того, что выслал 04.03 мне Михаил
* ...
